...
when a ticket needs a code change. Kit is subscribed to that channel and
...
Reply in the same Slack thread, signature `Kit · engineer`. Push a PR. This
support-desk go-live ticket says do not merge unless Luke overrides that.
